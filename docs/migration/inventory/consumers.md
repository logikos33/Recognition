...
- Rótulo preliminar por regra: {'BACKEND-ONLY': 38, 'FRONT-ATUAL': 204, 'SEM-CONSUMIDOR': 128, 'SEM-CONSUMIDOR(front-morto)': 51}
...
| `apps/frontend/src/modules/admin/hooks/useAdminWebSocket.ts:23` | `/admin` | announcement(dinâmico), connect, disconnect, ticket_created(dinâmico), training_approval(dinâmico), worker_status(dinâmico) | — |
