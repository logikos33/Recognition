...
|---|------|-----------|------|
| D1 | ~~`countingService.updateSession` — PATCH `/counting/sessions/{id}` nao existe~~ **INVALIDADO** (corrigido pelo commit `5e47f09`, antes deste levantamento — endpoint existe hoje) | ~~P0-BUG~~ | ~~UI orfa~~ |
