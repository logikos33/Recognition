...
- **holdout:** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/holdout/_annotations.coco.json` — 246 imagens no COCO, **246 avaliadas em TODAS as variantes**
- **modelo A (presença):** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/modelos/A_6ca25ee9.onnx` — dicionário: ['recognition', 'Botas', 'Luvas', 'Protetor auditivo', 'mascara', 'Óculos']
- **modelo B (presença+ausência):** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/modelos/B_1deadfb0.onnx` — dicionário: ['recognition', 'Botas', 'Luvas', 'Protetor auditivo', 'Sem Luvas', 'Sem botas', 'Sem mascara', 'Sem protetor de ouvido', 'Sem Óculos', 'Uso incorreto de mascara', 'mascara', 'Óculos']
- **modelo C (parte do corpo + EPI):** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/modelos/C_b9243540.onnx` — dicionário: ['recognition', 'botas', 'luva', 'mao', 'mascara', 'mascara_incorreta', 'oculos', 'orelha', 'pessoa', 'protetor_auricular', 'regiao_boca_nariz', 'regiao_olhos', 'rosto']
...
- **referência `BASELINE`:** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/modelos/BASE_b3ae42b6.onnx` — dicionário: ['recognition', 'Capacete', 'Luvas', 'Sem Luvas', 'Óculos', 'Sem Óculos', 'Protetor auditivo', 'mascara', 'Sem protetor de ouvido', 'Sem mascara', 'Botas', 'Uso incorreto de mascara', 'Sem botas'] — **fora do ranking**, entra só como régua do que o cliente já tem
- **referência `SERVIDO`:** `/private/tmp/claude-501/-Users-vitoremanuel-Documents-Logikos-CATH-EPI---CATH-V2/aa9d0a3b-183a-4bd0-a9cc-6b5cfc2e1078/scratchpad/ab/modelos/SERVIDO_46a30ed9.onnx` — dicionário: ['recognition', 'Capacete', 'Luvas', 'Sem Luvas', 'Óculos', 'Sem Óculos', 'Protetor auditivo', 'mascara', 'Sem protetor de ouvido', 'Sem mascara', 'Botas', 'Uso incorreto de mascara', 'Sem botas'] — **fora do ranking**, entra só como régua do que o cliente já tem
- **limiar aplicado:** 0.05 — **o MESMO para todas as variantes**
- **backend:** rfdetr_onnx
...
## Por classe de ausência (limiar 0.05)
...
| B · classe de ausência | 14 | 5 | 55 | 73.7% | 20.3% | 0 (0.0%) | 19 acus. / 69 reais |
| C · sobreposição geométrica | 40 | 21 | 29 | 65.6% | 58.0% | 61 (50.0%) | 61 acus. / 69 reais |
| BASELINE | 23 | 4 | 46 | 85.2% | 33.3% | 0 (0.0%) | 27 acus. / 69 reais |
| SERVIDO | 45 | 22 | 24 | 67.2% | 65.2% | 0 (0.0%) | 67 acus. / 69 reais |
...
- B: **n insuficiente** (n=19 < 30) — precisão sem n não é medida (ADR-0067).
- ⛔ **C: acusou 100% do que julgou (61/61).** Esta precisão É a prevalência da violação entre os quadros que ela julgou — aritmeticamente, não por semelhança. A variante não distinguiu nada; o número é do gabarito, não do modelo.
- C: **sustenta acusação** (precisão 65.6% ≥ 50%, n=61 ≥ 30).
  - 29 de 29 FN vieram de ABSTENÇÃO (não viu a âncora), não de julgamento errado.
- BASELINE: **n insuficiente** (n=27 < 30) — precisão sem n não é medida (ADR-0067).
- SERVIDO: **sustenta acusação** (precisão 67.2% ≥ 50%, n=67 ≥ 30).
- **veredito:** A vence — recall
...
| B · classe de ausência | 22 | 6 | 25 | 78.6% | 46.8% | 0 (0.0%) | 28 acus. / 47 reais |
| C · sobreposição geométrica | 37 | 34 | 10 | 52.1% | 78.7% | 40 (35.4%) | 71 acus. / 47 reais |
| BASELINE | 34 | 15 | 13 | 69.4% | 72.3% | 0 (0.0%) | 49 acus. / 47 reais |
| SERVIDO | 35 | 10 | 12 | 77.8% | 74.5% | 0 (0.0%) | 45 acus. / 47 reais |
...
- A: **NÃO sustenta acusação** — precisão 46.9% < 50% (ADR-0067).
  - 1 de 1 FN vieram de ABSTENÇÃO (não viu a âncora), não de julgamento errado.
- B: **n insuficiente** (n=28 < 30) — precisão sem n não é medida (ADR-0067).
- C: **sustenta acusação** (precisão 52.1% ≥ 50%, n=71 ≥ 30).
  - 9 de 10 FN vieram de ABSTENÇÃO (não viu a âncora), não de julgamento errado.
- BASELINE: **sustenta acusação** (precisão 69.4% ≥ 50%, n=49 ≥ 30).
- SERVIDO: **sustenta acusação** (precisão 77.8% ≥ 50%, n=45 ≥ 30).
- **veredito:** C vence — única que sustenta a régua
...
| B · classe de ausência | 0 | 6 | 0 | 0.0% | — | 0 (0.0%) | 6 acus. / 0 reais |
| C · sobreposição geométrica | 0 | 3 | 0 | 0.0% | — | 46 (93.9%) | 3 acus. / 0 reais |
| BASELINE | 0 | 3 | 0 | 0.0% | — | 0 (0.0%) | 3 acus. / 0 reais |
| SERVIDO | 0 | 6 | 0 | 0.0% | — | 0 (0.0%) | 6 acus. / 0 reais |
...
- B: **n insuficiente** (n=6 < 30) — precisão sem n não é medida (ADR-0067).
- ⛔ **C: acusou 100% do que julgou (3/3).** Esta precisão É a prevalência da violação entre os quadros que ela julgou — aritmeticamente, não por semelhança. A variante não distinguiu nada; o número é do gabarito, não do modelo.
- C: **n insuficiente** (n=3 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **BASELINE: precisão 0.0% não supera o controle nulo (0.0%).**
- BASELINE: **n insuficiente** (n=3 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **SERVIDO: precisão 0.0% não supera o controle nulo (0.0%).**
- SERVIDO: **n insuficiente** (n=6 < 30) — precisão sem n não é medida (ADR-0067).
...
|---|---:|---:|---:|---:|---:|---:|---|
| A · presença derivada | 0 | 35 | 0 | 0.0% | — | 14 (28.6%) | 35 acus. / 0 reais |
| B · classe de ausência | 0 | 23 | 0 | 0.0% | — | 0 (0.0%) | 23 acus. / 0 reais |
| C · sobreposição geométrica | 0 | 46 | 0 | 0.0% | — | 0 (0.0%) | 46 acus. / 0 reais |
| BASELINE | 0 | 8 | 0 | 0.0% | — | 0 (0.0%) | 8 acus. / 0 reais |
| SERVIDO | 0 | 8 | 0 | 0.0% | — | 0 (0.0%) | 8 acus. / 0 reais |
...
- A: **NÃO sustenta acusação** — precisão 0.0% < 50% (ADR-0067).
- ⚠️ **B: precisão 0.0% não supera o controle nulo (0.0%).**
- B: **n insuficiente** (n=23 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **C: precisão 0.0% não supera o controle nulo (0.0%).**
- C: **NÃO sustenta acusação** — precisão 0.0% < 50% (ADR-0067).
- ⚠️ **BASELINE: precisão 0.0% não supera o controle nulo (0.0%).**
- BASELINE: **n insuficiente** (n=8 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **SERVIDO: precisão 0.0% não supera o controle nulo (0.0%).**
- SERVIDO: **n insuficiente** (n=8 < 30) — precisão sem n não é medida (ADR-0067).
- **veredito:** sem veredito — nenhuma sustenta a régua
...
| B · classe de ausência | 0 | 33 | 0 | 0.0% | — | 0 (0.0%) | 33 acus. / 0 reais |
| C · sobreposição geométrica | 0 | 0 | 0 | — | — | 49 (100.0%) | 0 acus. / 0 reais |
| BASELINE | 0 | 30 | 0 | 0.0% | — | 0 (0.0%) | 30 acus. / 0 reais |
| SERVIDO | 0 | 29 | 0 | 0.0% | — | 0 (0.0%) | 29 acus. / 0 reais |

- ⛔ **NÃO CONCLUSIVA — o gabarito não tem nenhum `sim` para esta classe.** Sem um positivo real não há recall para medir, e a precisão só pode dar 0%: toda acusação cai contra um denominador de zero verdades. Isso mede o gabarito, não o modelo. Nenhum veredito é emitido aqui — e a ausência dele é o resultado.

- A: **n insuficiente** (n=0 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **B: precisão 0.0% não supera o controle nulo (0.0%).**
- B: **NÃO sustenta acusação** — precisão 0.0% < 50% (ADR-0067).
- C: **n insuficiente** (n=0 < 30) — precisão sem n não é medida (ADR-0067).
- ⚠️ **BASELINE: precisão 0.0% não supera o controle nulo (0.0%).**
- BASELINE: **NÃO sustenta acusação** — precisão 0.0% < 50% (ADR-0067).
- ⚠️ **SERVIDO: precisão 0.0% não supera o controle nulo (0.0%).**
- SERVIDO: **n insuficiente** (n=29 < 30) — precisão sem n não é medida (ADR-0067).
- **veredito:** sem veredito — nenhuma sustenta a régua
...
| limiar | classe | A precisão/recall (n) | B precisão/recall (n) | C precisão/recall (n) | BASELINE precisão/recall (n) | SERVIDO precisão/recall (n) |
|---:|---|---|---|---|---|---|
| 0.05 | Sem Luvas | 63.6% / 98.6% (107) | 73.7% / 20.3% (19) | 65.6% / 58.0% (61) | 85.2% / 33.3% (27) | 67.2% / 65.2% (67) |
| 0.05 | Sem mascara | 46.9% / 97.9% (98) | 78.6% / 46.8% (28) | 52.1% / 78.7% (71) | 69.4% / 72.3% (49) | 77.8% / 74.5% (45) |
| 0.05 | Sem Óculos | 0.0% / — (35) | 0.0% / — (6) | 0.0% / — (3) | 0.0% / — (3) | 0.0% / — (6) |
| 0.05 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (23) | 0.0% / — (46) | 0.0% / — (8) | 0.0% / — (8) |
| 0.05 | Uso incorreto de mascara | — / — (0) | 0.0% / — (33) | — / — (0) | 0.0% / — (30) | 0.0% / — (29) |
| 0.07 | Sem Luvas | 63.6% / 98.6% (107) | 66.7% / 11.6% (12) | 67.7% / 30.4% (31) | 93.8% / 21.7% (16) | 72.9% / 50.7% (48) |
| 0.07 | Sem mascara | 46.9% / 97.9% (98) | 81.8% / 38.3% (22) | 50.9% / 59.6% (55) | 81.1% / 63.8% (37) | 89.7% / 55.3% (29) |
| 0.07 | Sem Óculos | 0.0% / — (35) | — / — (0) | 0.0% / — (1) | 0.0% / — (3) | 0.0% / — (1) |
| 0.07 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (14) | 0.0% / — (46) | 0.0% / — (8) | 0.0% / — (5) |
| 0.07 | Uso incorreto de mascara | — / — (0) | 0.0% / — (28) | — / — (0) | 0.0% / — (28) | 0.0% / — (27) |
| 0.10 | Sem Luvas | 63.6% / 98.6% (107) | 50.0% / 2.9% (4) | 30.8% / 5.8% (13) | 91.7% / 15.9% (12) | 87.5% / 30.4% (24) |
| 0.10 | Sem mascara | 46.9% / 97.9% (98) | 87.5% / 29.8% (16) | 51.3% / 42.6% (39) | 92.3% / 51.1% (26) | 90.5% / 40.4% (21) |
| 0.10 | Sem Óculos | 0.0% / — (35) | — / — (0) | 0.0% / — (1) | 0.0% / — (1) | — / — (0) |
| 0.10 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (12) | 0.0% / — (49) | 0.0% / — (5) | 0.0% / — (1) |
| 0.10 | Uso incorreto de mascara | — / — (0) | 0.0% / — (16) | — / — (0) | 0.0% / — (23) | 0.0% / — (22) |
| 0.15 | Sem Luvas | 63.6% / 98.6% (107) | — / 0.0% (0) | 12.5% / 1.4% (8) | 100.0% / 7.2% (5) | 100.0% / 8.7% (6) |
| 0.15 | Sem mascara | 46.9% / 97.9% (98) | 91.7% / 23.4% (12) | 40.7% / 23.4% (27) | 100.0% / 40.4% (19) | 100.0% / 19.1% (9) |
| 0.15 | Sem Óculos | 0.0% / — (35) | — / — (0) | — / — (0) | 0.0% / — (1) | — / — (0) |
| 0.15 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (7) | 0.0% / — (41) | 0.0% / — (2) | — / — (0) |
| 0.15 | Uso incorreto de mascara | — / — (0) | 0.0% / — (7) | — / — (0) | 0.0% / — (14) | 0.0% / — (12) |
| 0.20 | Sem Luvas | 63.6% / 98.6% (107) | — / 0.0% (0) | 0.0% / 0.0% (7) | 100.0% / 5.8% (4) | 100.0% / 1.4% (1) |
| 0.20 | Sem mascara | 46.9% / 97.9% (98) | 100.0% / 14.9% (7) | 36.4% / 17.0% (22) | 100.0% / 29.8% (14) | 100.0% / 6.4% (3) |
| 0.20 | Sem Óculos | 0.0% / — (35) | — / — (0) | — / — (0) | 0.0% / — (1) | — / — (0) |
| 0.20 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (3) | 0.0% / — (37) | — / — (0) | — / — (0) |
| 0.20 | Uso incorreto de mascara | — / — (0) | 0.0% / — (2) | — / — (0) | 0.0% / — (6) | 0.0% / — (5) |
| 0.30 | Sem Luvas | 63.6% / 98.6% (107) | — / 0.0% (0) | 0.0% / 0.0% (4) | — / 0.0% (0) | — / 0.0% (0) |
| 0.30 | Sem mascara | 46.9% / 97.9% (98) | 100.0% / 6.4% (3) | 26.7% / 8.5% (15) | 100.0% / 14.9% (7) | — / 0.0% (0) |
| 0.30 | Sem Óculos | 0.0% / — (35) | — / — (0) | — / — (0) | — / — (0) | — / — (0) |
| 0.30 | Sem protetor de ouvido | 0.0% / — (35) | 0.0% / — (1) | 0.0% / — (22) | — / — (0) | — / — (0) |
| 0.30 | Uso incorreto de mascara | — / — (0) | — / — (0) | — / — (0) | — / — (0) | — / — (0) |

## Varredura do limiar de SOBREPOSIÇÃO da variante C (confiança fixa em 0.05)
...
|---:|---|---:|---:|---:|---:|---:|
| 0.10 | Sem Luvas | 40 | 21 | 29 | 65.6% | 58.0% |
| 0.10 | Sem mascara | 37 | 34 | 10 | 52.1% | 78.7% |
| 0.10 | Sem Óculos | 0 | 3 | 0 | 0.0% | — |
| 0.10 | Sem protetor de ouvido | 0 | 39 | 0 | 0.0% | — |
| 0.25 | Sem Luvas | 40 | 21 | 29 | 65.6% | 58.0% |
| 0.25 | Sem mascara | 37 | 34 | 10 | 52.1% | 78.7% |
| 0.25 | Sem Óculos | 0 | 3 | 0 | 0.0% | — |
| 0.25 | Sem protetor de ouvido | 0 | 41 | 0 | 0.0% | — |
| 0.50 | Sem Luvas | 40 | 21 | 29 | 65.6% | 58.0% |
| 0.50 | Sem mascara | 37 | 34 | 10 | 52.1% | 78.7% |
| 0.50 | Sem Óculos | 0 | 3 | 0 | 0.0% | — |
| 0.50 | Sem protetor de ouvido | 0 | 46 | 0 | 0.0% | — |
| 0.75 | Sem Luvas | 40 | 21 | 29 | 65.6% | 58.0% |
| 0.75 | Sem mascara | 37 | 34 | 10 | 52.1% | 78.7% |
| 0.75 | Sem Óculos | 0 | 3 | 0 | 0.0% | — |
| 0.75 | Sem protetor de ouvido | 0 | 48 | 0 | 0.0% | — |
| 0.90 | Sem Luvas | 40 | 21 | 29 | 65.6% | 58.0% |
| 0.90 | Sem mascara | 37 | 34 | 10 | 52.1% | 78.7% |
| 0.90 | Sem Óculos | 0 | 3 | 0 | 0.0% | — |
| 0.90 | Sem protetor de ouvido | 0 | 48 | 0 | 0.0% | — |

## Veredito geral

**EMPATE entre A, C (A=1, B=0, C=1) → vence a mais simples: A**
