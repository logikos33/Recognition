...
# admin
import os
_admin_pw = os.environ.get("RVB_ADMIN_PASSWORD")
if not _admin_pw:
    raise SystemExit("Defina RVB_ADMIN_PASSWORD no ambiente antes de rodar o embarque.")
pw = bcrypt.hashpw(_admin_pw.encode(), bcrypt.gensalt()).decode()
