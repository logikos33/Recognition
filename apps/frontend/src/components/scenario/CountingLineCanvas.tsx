/**
 * CountingLineCanvas — canvas SVG para desenho de linha de cruzamento (contagem).
 *
...
interface CountingLineCanvasProps {
...
export function CountingLineCanvas({
  line,
  onChange,
  width = 480,
  height = 270,
