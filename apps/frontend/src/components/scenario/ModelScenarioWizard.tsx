/**
 * ModelScenarioWizard — wizard de 6 passos para configurar um modelo treinado.
 *
 * Passos:
 *   1. Identificação  — nome do modelo + descrição
 *   2. Classes        — checkboxes das classes a detectar
 *   3. Linha          — CountingLineCanvas (linha de cruzamento p/ contagem)
 ...
 *   - pointerEvents:'none' nos shapes SVG (delegado a CountingLineCanvas e RoiDrawer)
 */
import { useCallback, useEffect, useState } from 'react'
import { X, ChevronLeft, ChevronRight, Check, Loader2 } from 'lucide-react'
import { Stepper } from '../ui/Stepper/Stepper'
import { Button } from '../ui/Button/Button'
import { CountingLineCanvas } from './CountingLineCanvas'
import type { CountingLine } from './CountingLineCanvas'
...
export interface ModelScenarioWizardProps {
  modelId: string
  modelName: string
  onClose: () => void
  onSaved?: () => void
...
export function ModelScenarioWizard({ modelId, modelName, onClose, onSaved }: ModelScenarioWizardProps) {
