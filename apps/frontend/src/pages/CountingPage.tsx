 ...
 *
 * @migrado-para src/app/carga/Carga.tsx
 * rota nova: /novo/carga
 *
 * @paridade-pendente iniciar contagem (seleção de câmera + abrir sessão — POST /counting/sessions); ver o resultado final logo após encerrar a sessão (a substituta só remove o cartão da lista, sem o painel de totais)
 *
