 ...
 *
 * @paridade-pendente edição da configuração da câmera (ordem de produção / tipo de peça — startEdit/saveEdit); atribuir e remover câmera do módulo (assign/unassign)
 *
