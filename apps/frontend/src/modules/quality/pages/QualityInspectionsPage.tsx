 ...
 *
 * @migrado-para src/app/qualidade/RevisaoQualidade.tsx
 * rota nova: /novo/quality/revisao
 *
 * @paridade-pendente filtro por resultado (OK/NOK); filtro por status de feedback; filtro por período (data de/até); filtro por ordem de produção; paginação (a substituta só mostra os mais recentes, sem "página X de Y" nem Anterior/Próxima)
 *
