 ...
 *
 * @migrado-para src/app/qualidade/ConfigQualidade.tsx
 * rota nova: /novo/quality/configuracao
 *
 * @paridade-pendente criar estação (modal "+ Adicionar estação", POST /gate/stations); editar estação (nome, controlador de torre, câmeras overview/closeup — PATCH /gate/stations/<code>); salvar configuração global do gate (padrão OCR, thresholds de votação V1/V2/V3, frames por validação, confiança mínima — PATCH /gate/config)
 *
