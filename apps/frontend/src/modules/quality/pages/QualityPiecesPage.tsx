 ...
 *
 * @migrado-para src/app/qualidade/GestaoQualidade.tsx
 * rota nova: /novo/quality/gestao
 *
 * @paridade-pendente filtro por data — a rota `/gate/pieces` não lê date_from/date_to e a tela nova nem oferece o campo
 *
