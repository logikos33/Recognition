 ...
 *
 * Desenho: `Admin Plataforma.dc.html`. SR2 PR-1 trouxe "Visão geral"; PR-3
 * acrescenta "Dispositivos" e "Auditoria". As demais abas da lateral do
 * desenho (Tenants, Usuários, Links) chegam em PRs paralelas/seguintes da
 * F5. Item apontando para rota inexistente é tela inventada.
 *
...
import { HardDrive, LayoutDashboard, ScrollText } from 'lucide-react'
