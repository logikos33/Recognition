...
`EVIDENCE_DIR` aponta para um diretório temporário: o spec `task-063-visual`
grava capturas em `docs/quality/evidence/`, e um comando de VERIFICAÇÃO não pode
sujar o repositório — na primeira versão ele reescreveu 10 PNGs versionados.
