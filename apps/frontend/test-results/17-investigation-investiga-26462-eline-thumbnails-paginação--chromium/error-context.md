...
- Name: 17-investigation.spec.ts >> investigation — default (rico, filtros + timeline + thumbnails + paginação)
- Location: src/test/e2e/visual-audit/17-investigation.spec.ts:146:1
