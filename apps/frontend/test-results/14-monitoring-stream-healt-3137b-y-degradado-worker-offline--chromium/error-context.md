...
- Name: 14-monitoring.spec.ts >> stream-health — degraded (Redis fora, gateway degradado, worker offline)
- Location: src/test/e2e/visual-audit/14-monitoring.spec.ts:349:1
