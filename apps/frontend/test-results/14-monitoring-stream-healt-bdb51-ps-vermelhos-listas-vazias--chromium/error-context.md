...
- Name: 14-monitoring.spec.ts >> stream-health — error (500 em tudo → chips vermelhos + listas vazias)
- Location: src/test/e2e/visual-audit/14-monitoring.spec.ts:334:1
